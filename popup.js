/* ============================
   ...
   ============================ */
const ICON_DOWNLOAD = `<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7 1v7m0 0l-3-3m3 3l3-3M2 9.5v.3c0 1.2 0 1.7.3 2 .3.2.7.2 1.7.2h6c1 0 1.4 0 1.7-.2.3-.3.3-.8.3-2v-.3" stroke="#0D0F0D" stroke-linecap="round" stroke-linejoin="round"/></svg>`;
...
const ICON_NO_INTERNET = `<svg xmlns="http://www.w3.org/2000/svg" width="150" height="151" viewBox="0 0 150 151" fill="none">
...
const ICON_RETRY = `<svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
